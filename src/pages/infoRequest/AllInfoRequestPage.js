...
const AllInfoRequestPage = () => {
  ...
  const handleEmailSend = async () => {
    try {
      ...
      await apis.sendEmailForInfoRequest(data.join());
      init();
    } catch (error) {
    } finally {
    ...
    <Box>
      ...
      >
        ...
        <DialogContent>
          ...
          >
            <Typography variant="body1">
              Are you going to send an email for selected information requests?
            </Typography>
            <Typography variant="body1">
              Please check information requests again to determine if it is not
              spam or if there is anything you need to change.
            </Typography>
...
export default AllInfoRequestPage;
