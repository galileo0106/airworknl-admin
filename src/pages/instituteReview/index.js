...
const InstituteReviewPage = () => {
      ...
      renderCell: (params) => {
        return (
          <Stack direction="row" spacing={1}>
            ...
            <IconButton
              onClick={() => {
                navigate(`/institute/${institute_id}/review/${params.id}/edit`);
              }}
            >
              <EditIcon />
            </IconButton>
  ...
  const init = async () => {
    try {
      const {
        data: { reviews },
      } = await apis.getReviews(`?posts=${institute_id}&type=Institute`);
      setRows(reviews);
    } catch (error) {}
  };
        ...
        <Stack direction="row" spacing={2} justifyContent="space-between">
          <Box gap={1} display="flex">
            ...
            <Button
              variant="contained"
              onClick={() =>
                navigate(`/institute/${institute_id}/review/create`)
              }
              startIcon={<AddIcon />}
            >
              Create Review
...
export default InstituteReviewPage;
